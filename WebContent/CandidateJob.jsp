...
<div id="id01" class="modal">
        ...
        <%@page import="com.dbproperties.pkg.Job,com.model.pkg.CandidateJobM,java.util.*"%>  
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>  
  
<h1>Job Requirement</h1>  
  
<%  
List<Job> list=CandidateJobM.getAllRecords(id);  
request.setAttribute("list",list);  
%>  
<table id="myTd" border="1">  
<tr><th>Job ID</th><th>COMPANY NAME</th><th>Job Type</th><th>Skill</th>  
<th>Experience</th><th>Valid Till</th><th>Vacancy</th><th>Apply</th></tr>  
...
<td colspan="1" style="display:none;text-align: -webkit-center;background-color: #4CAF50;">
...
function deletejob(id) {
	  ...
	  xhttp.open("GET", "CandidateJobC?jobid="+id, true);
	  xhttp.send(); 
